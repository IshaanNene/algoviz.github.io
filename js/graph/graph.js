...
const CELL = { EMPTY: 0, WALL: 1, START: 2, TARGET: 3, WEIGHT: 4 };
...
class PathGrid {
    ...
    setWall(r, c) {
        ...
        if (this.cells[r][c] === CELL.START || this.cells[r][c] === CELL.TARGET) return;
    ...
    moveStart(r, c) {
        if (!this.isInBounds(r, c) || this.cells[r][c] === CELL.TARGET) return;
    ...
    moveTarget(r, c) {
        if (!this.isInBounds(r, c) || this.cells[r][c] === CELL.START) return;
